...
public class user_success extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragement=new Home();
        ft.replace(R.id.frame_content,fragement);
        ft.commit();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
           ...
           fragement=new Home();
            ...
            fragement=new Transactions();

        } else if (id == R.id.transfer) {
            setTitle("Transfer Amount");
            fragement=new Transfer();
        } else if (id == R.id.profile) {
            setTitle("Profile");
        fragement=new Profile();
        }
        else if (id == R.id.changepassword) {
            setTitle("Change Password");
          fragement=new ChangePassword();
        }
         if(fragement!=null){
            FragmentTransaction ft=getSupportFragmentManager().beginTransaction();
            ft.replace(R.id.frame_content,fragement);
